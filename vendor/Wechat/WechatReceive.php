...
class WechatReceive extends WechatMessage
{
     ...
     * @return bool|string
     */
    public function getReceiveCtime()
    {
     ...
     */
    public function getReceiveCardPass()
    {
     ...
     * @return bool|array
     */
    public function getReceiveCardGet()
    {
        $array = array();
        if (isset($this->receive['CardId'])) {
     ...
     * @return bool|array
     */
    public function getReceiveCardDel()
    {
     ...
     * @return bool|array
     */
    public function getReceiveEventGeo()
    {
     ...
     * @return bool|array
     */
    public function getReceiveScanInfo()
    {
     ...
     *
     */
    public function getReceiveSendPicsInfo()
    {
     ...
     *
     */
    public function getReceiveSendGeoInfo()
    {
     ...
     * @return bool|array
     */
    public function getReceiveVoice()
    {
     ...
     * @return array|bool
     */
    public function getReceiveVideo()
    {
        if (isset($this->receive['MediaId'])) {
            return array(
                'mediaid'      => $this->receive['MediaId'],
     ...
     * @return bool|string
     */
    public function getReceiveSceneId()
    {
        if (isset($this->receive['EventKey'])) {
     ...
     * @return bool|string
     */
    public function getReceiveTplMsgID()
    {
        if (isset($this->receive['MsgID'])) {
            return $this->receive['MsgID'];
        }
     ...
     * @return bool|string
     */
    public function getReceiveKFCreate()
    {
     ...
     * @return bool|string
     */
    public function getReceiveKFClose()
    {
        if (isset($this->receive['KfAccount'])) {
            return $this->receive['KfAccount'];
        }
     ...
     * @return bool|array
     */
    public function getReceiveKFSwitch()
    {
    ...
    public function sendCustomMessage($data)
    {
        ...
        $result = Tools::httpPost(self::API_URL_PREFIX . "/message/custom/send?access_token={$this->accessToken}", Tools::json_encode($data));
        if ($result) {
    ...
    {
        $msg = array(
            'ToUserName'   => $this->getReceiveFrom(),
            'FromUserName' => $this->getReceiveTo(),
            'CreateTime'   => time(),
